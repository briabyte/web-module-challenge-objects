...
console.log(createMenuItem('Frittata', 13, 'Brunch'));
console.log(createMenuItem('Pasta', 16, 'Italian'));
console.log(createMenuItem('Cookies', 2, 'Dessert'));
...
function createNewReveiw(name, rating, feedback){
  return {name, rating, feedback}
}
console.log(createNewReveiw('Bria', 2, 'This place smells funny'));
